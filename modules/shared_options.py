...
options_templates.update(options_section(('saving-images', "Saving images/grids", "saving"), {
    ...
    "samples_format": OptionInfo('png', 'File format for images', ui_components.DropdownEditable, {"choices": ("png", "jpg", "jpeg", "webp", "avif", "tga", "safetensors")}).info("manual input of <a href='https://pillow.readthedocs.io/en/stable/handbook/image-file-formats.html' target='_blank'>other formats</a> is possible, but compatibility is not guaranteed; 'safetensors' writes raw float32 image data per the SFI spec"),
    ...
    "grid_format": OptionInfo('png', 'File format for grids', ui_components.DropdownEditable, {"choices": ("png", "jpg", "jpeg", "webp", "avif", "tga", "safetensors")}).info("manual input of <a href='https://pillow.readthedocs.io/en/stable/handbook/image-file-formats.html' target='_blank'>other formats</a> is possible, but compatibility is not guaranteed; 'safetensors' writes raw float32 image data per the SFI spec"),
